package com.atguigu.gulionline.edu.test;
...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        String prefix = "sh0923-";//用来拼接连接数据库的url地址数据库名称的、根据实际修改
        ...
        // D:\JavaEE_Second\stage6_onlineedu\0923onlineguli\guli-parents\services\service-edu
...
//        gc.setFileOverride(true); //重新生成时文件是否覆盖
        ...
        // com.atguigu.gulionline.service.edu  entity/service/controller/mapper
        pc.setModuleName(moduleName); //模块名
        pc.setParent("com.atguigu.gulionline.service");
        ...
        //设置BaseEntity
        strategy.setSuperEntityClass("com.atguigu.gulionline.service.base.model.BaseEntity");
        // 填写BaseEntity中的公共字段
